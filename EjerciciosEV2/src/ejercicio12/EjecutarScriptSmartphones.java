...
public class EjecutarScriptSmartphones {
	...
	public static void ejecutarScriptMySQL() {
		File scriptFile = new File("./script/smartphones.sql");
		System.out.println("--------------------------------------------");
		...
		try {
			Connection connmysql = (Connection) DriverManager
					.getConnection("jdbc:mysql://localhost/probrandoScripts?allowMultiQueries=true", "ejemplo", "ejemplo");
